// ══════════════════════════════════════════════
// ⚙️ إعدادات Firebase — ضع بياناتك هنا
// ══════════════════════════════════════════════
...
// ── SUBMIT RIDE REQUEST — بيبعت على Firebase ──
async function submitRideRequest() {
  ...
  // ── بعت على Firebase ──
  try {
    const dbUrl = FIREBASE_CONFIG.databaseURL + '/requests/' + request.id + '.json';
    await fetch(dbUrl, {
      method: 'PUT',
